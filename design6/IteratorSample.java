...
public class IteratorSample {
	public static void main(String[] args) {
		...
		gameListAggregate.add(new Game("太平洋の嵐", "G.A.M"));
		gameListAggregate.add(new Game("人生ゲーム ハッピーファミリー", "タカラトミー"));
		gameListAggregate.add(new Game("スペランカー", "マイクロ・グラフィック・イメージ"));
		gameListAggregate.add(new Game("クラッシュバンディクー", "Naughty Dog"));
		iterator.first();
